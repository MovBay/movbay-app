...
const ProductCreate = () => {
  ...
  // )
   ...
   const categoryItems = useMemo(
     () => [
       {label: 'Electronics_Gadgets', value: 'Electronics_Gadgets'},
       {label: 'Fashion_Wears', value: 'Fashion_Wears'},
       {label: 'Furniture_Fittings', value: 'Furniture_Fittings'},
       {label: 'Health_Beauty', value: 'Health_Beauty'},
       {label: 'Hot_Food', value: 'Hot_Food'},
       {label: 'Dry_Food_Supplements', value: 'Dry_Food_Supplements'},
       {label: 'Groceries', value: 'Groceries'},
       {label: 'Sensitive_Items', value: 'Sensitive_Items'},
       {label: 'Light_Weight_Items', value: 'Light_Weight_Items'},

...
import { useMarkOrderOutForDelivery } from "@/hooks/mutations/sellerAuth"
        ...
        >
          ...
          <ScrollView className="flex-1 mb-4">
            <View className="items-center mb-2">
              ...
              >
                Mark for Delivery Failed
              </Text>
              <Text className="text-gray-600 text-center px-10" style={{ fontFamily: "HankenGrotesk_400Regular" }}>
                Failed to mark order for delivery. Please try again or reach out to our customer care.
              </Text>
            </View>
          </ScrollView>
          {/* Button */}
      ...
      <View className="flex-1">
        ...
        >
          ...
          <View className="items-center mb-6">
            ...
            <Text className="text-gray-600 text-center px-10" style={{ fontFamily: "HankenGrotesk_400Regular" }}>
              Your order has been successfully marked as out for delivery. The buyer will be notified.
            </Text>
            <Text
...
const OrderMarkForDelivery = () => {
  ...
  const { mutate: markOrderOutForDelivery, isPending } = useMarkOrderOutForDelivery(orderId)
  ...
  const handleMarkForDelivery = () => {
    console.log("🔍 Attempting to mark order for delivery:", orderId)
    ...
    markOrderOutForDelivery(
      ...
      {
        onSuccess: (data) => {
          console.log("✅ Order marked for delivery successfully:", data?.data)
        ...
        onError: (error) => {
          ...
          setErrorDetails((error as any)?.response?.data || error.message || error)
    ...
    <SafeAreaView className="bg-white flex-1">
      ...
      <View style={styles.fixedBottomContainer} className="bg-white border-t border-gray-200">
        <View className="flex-row gap-3 justify-center">
          <View className="w-[48%]">
            <SolidLightButton text="Cancel" onPress={handleCancelAction} />
          </View>
          <View className="w-[48%]">
            <SolidMainButton text={"Mark for Delivery"} onPress={handleMarkForDelivery} />
          </View>
        </View>
      </View>
      {/* Success Modal */}
...
export default OrderMarkForDelivery

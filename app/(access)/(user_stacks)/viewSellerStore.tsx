...
const ViewSellerStore = () => {
  ...
  console.log('This is store data', userProductData?.data?.results)
  ...
  return (
    <SafeAreaView className='flex-1 bg-white px-8'>
        ...
        {isLoading || productLoading ? 
          ...
          <KeyboardAwareScrollView className='pt-0'>
            <View className=''>
              ...
              <View className='pt-5 flex-row items-center justify-between'>
                <View>
                  ...
                  <Text className='text-sm text-gray-500' style={{fontFamily: 'HankenGrotesk_400Regular'}}>{storeData?.data?.description}</Text>
                </View>
              </View>

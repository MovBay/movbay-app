...
const RidersFAQAndSupport = () => {
  ...
  const menuItems: {
    ...
    },
    {
      ...
      onPress: () => {
        router.push('/(access)/(rider_stacks)/contactSupport')
      }
    },
    {
      icon: "more-horiz",
      ...
      onPress: () => {
        router.push('/(access)/(rider_stacks)/ridersTermsAndCondition')
      }
    },
    {
      icon: "person-2",
      ...
      onPress: () => {
        router.push('/(access)/(rider_stacks)/ridersAbout')
      }
    }
  ]
...
export default RidersFAQAndSupport